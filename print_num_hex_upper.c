...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   print_num_hex_upper.c                              :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: nselaule <marvin@42.fr>                    +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2018/08/03 07:28:19 by nselaule          #+#    #+#             */
/*   Updated: 2018/08/10 10:45:17 by nselaule         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int     print_num_hex_upper(t_printf **strrs, va_list args)
{
    ...
    str = ft_itoa_base_upper(get_value_uns(strrs, args), 16);
    ret = 0;
    sign = 0;
